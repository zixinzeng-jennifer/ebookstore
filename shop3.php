...
详细填写收货人信息、送货方式、书目信息等，确认无误后点击“提交订单”。
	...
	<div class="navitem"><a  class="active" href="shop3.php" >分店3</a></div>
...
<div class="hor" style="background-color: #FEFDED"><strong>红山路店(分店3)</strong></div>
<div class="row">
	<div class="left">
	  <ul class="leftnav">
...
echo  ' <div style="height:5%"><form name="form6">
	...
	<img src="shop3.jpg" height=auto width=100%></a>
	</div>
	<div class="right" style="background-color: #FEFDED">
		...
		&#12288;&#12288;2019.12.15~2020.1.15在店内购书享受以下满减优惠：满50元减5元，满100元减10元，满200元减15元</font>
		</div>
		<div class="right" style="height:54%">
		<strong>本店特色：</strong><br>
		&#12288;&#12288;红山路店是“神奇书店”分店中图书种类最均衡的，无论您需要寻找哪种类型的图书，红山路店总是不会让您失望。店内拥有宽阔舒适的大面积阅读空间，让您在购书期间拥有充分选择空间。<br>
		<strong>地址：</strong><br>北京市海淀区红山路红山口甲8号<br>
		<strong>联系电话：</strong>64040781</div>
...
/*分店3热销书*/
$result=mysqli_query($conn,"SELECT title,book.ISBN,publisher, price, classification, allauthor, alltranslator,url FROM book, transaction,storage WHERE (book.ISBN=transaction.ISBN and book.ISBN=storage.ISBN and storage.shopno='3') GROUP BY book.ISBN ORDER BY SUM(number)DESC");
$i=0;
...
$result=mysqli_query($conn,"SELECT title, publisher, price, edition,classification, allauthor, alltranslator,url,Cintroduction,Eintroduction FROM book, `book-classification`,`storage` WHERE book.ISBN=`book-classification`.ISBN AND book.ISBN=`storage`.ISBN AND `storage`.shopno=3 AND `book-classification`.cno=4");
...
$result=mysqli_query($conn,"SELECT title, publisher, price, edition,classification, allauthor, alltranslator,url,Cintroduction,Eintroduction FROM book, `book-classification`,`storage` WHERE book.ISBN=`book-classification`.ISBN AND book.ISBN=`storage`.ISBN AND `storage`.shopno=3 AND `book-classification`.cno=1");
while($row=mysqli_fetch_array($result))
{
    echo'<div class="book1">';
    echo'<div class="image1"><a target="_blank" href="_blank"><img src="'.$row['url'].'" height="150"></a></div>';
...
$result=mysqli_query($conn,"SELECT title, publisher, price, edition,classification, allauthor, alltranslator,url,Cintroduction,Eintroduction FROM book, `book-classification`,`storage` WHERE book.ISBN=`book-classification`.ISBN AND book.ISBN=`storage`.ISBN AND `storage`.shopno=3 AND `book-classification`.cno=7");
while($row=mysqli_fetch_array($result))
{
    echo'<div class="book1">';
    echo'<div class="image1"><a target="_blank" href="_blank"><img src="'.$row['url'].'" height="150"></a></div>';
...
$result=mysqli_query($conn,"SELECT title, publisher, price, edition,classification, allauthor, alltranslator,url,Cintroduction,Eintroduction FROM book, `book-classification`,`storage` WHERE book.ISBN=`book-classification`.ISBN AND book.ISBN=`storage`.ISBN AND `storage`.shopno=3 AND `book-classification`.cno=2");
while($row=mysqli_fetch_array($result))
{
    echo'<div class="book1">';
    echo'<div class="image1"><a target="_blank" href="_blank"><img src="'.$row['url'].'" height="150"></a></div>';
...
$result=mysqli_query($conn,"SELECT title, publisher, price, edition,classification, allauthor, alltranslator,url,Cintroduction,Eintroduction FROM book, `book-classification`,`storage` WHERE book.ISBN=`book-classification`.ISBN AND book.ISBN=`storage`.ISBN AND `storage`.shopno=3 AND `book-classification`.cno=3");
while($row=mysqli_fetch_array($result))
{
    echo'<div class="book1">';
    echo'<div class="image1"><a target="_blank" href="_blank"><img src="'.$row['url'].'" height="150"></a></div>';
...
$result=mysqli_query($conn,"SELECT title, publisher, price, edition,classification, allauthor, alltranslator,url,Cintroduction,Eintroduction FROM book, `book-classification`,`storage` WHERE book.ISBN=`book-classification`.ISBN AND book.ISBN=`storage`.ISBN AND `storage`.shopno=3 AND `book-classification`.cno=5");
while($row=mysqli_fetch_array($result))
{
    echo'<div class="book1">';
    echo'<div class="image1"><a target="_blank" href="_blank"><img src="'.$row['url'].'" height="150"></a></div>';
...
$result=mysqli_query($conn,"SELECT title, publisher, price, edition,classification, allauthor, alltranslator,url,Cintroduction,Eintroduction FROM book, `book-classification`,`storage` WHERE book.ISBN=`book-classification`.ISBN AND book.ISBN=`storage`.ISBN AND `storage`.shopno=3 AND `book-classification`.cno=6");
while($row=mysqli_fetch_array($result))
{
    echo'<div class="book1">';
    echo'<div class="image1"><a target="_blank" href="_blank"><img src="'.$row['url'].'" height="150"></a></div>';
...
$result=mysqli_query($conn,"SELECT title, publisher, price, edition,classification, allauthor, alltranslator,url,Cintroduction,Eintroduction FROM book, `book-classification`,`storage` WHERE book.ISBN=`book-classification`.ISBN AND book.ISBN=`storage`.ISBN AND `storage`.shopno=3 AND `book-classification`.cno=8");
while($row=mysqli_fetch_array($result))
{
    echo'<div class="book1">';
    echo'<div class="image1"><a target="_blank" href="_blank"><img src="'.$row['url'].'" height="150"></a></div>';
...
<div class="row">
  <div class="navitem" style="flex:50%;background-image:url('bg.jpg');">
	<div class="navitem">神奇书店在哪里 分店3</div></div>
